...
public class DatabaseInitializer {
    ...
    private static void addLoan(final AppDatabase db, final int id,
    ...
    private static Book addBook(final AppDatabase db, final int id, final String title) {
        Book book = new Book();
        book.id = id;
        book.title = title;
    ...
    private static User addUser(final AppDatabase db, final int id, final String name,
